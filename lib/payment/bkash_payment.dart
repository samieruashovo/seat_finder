...
class BkashPaymentMethod extends StatefulWidget {
  final String title;

  const BkashPaymentMethod({Key? key, required this.title}) : super(key: key);

  @override
  BkashPaymentMethodState createState() => BkashPaymentMethodState();
}

class BkashPaymentMethodState extends State<BkashPaymentMethod> {
